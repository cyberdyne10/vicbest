...
1. **AI product assistant**
   ...
   - Deterministic heuristic fallback (budget/category/use-case parsing)
   - Storefront chat widget (`index.html` + `main.js`)
...
- AI endpoint currently uses deterministic fallback heuristics only in this phase (no outbound AI call yet).
